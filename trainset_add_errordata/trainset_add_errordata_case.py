from SISSOfit import ZoomObfuscator, ShuffleObfuscator, DataProvider, SISSOLearning, Drawing

if __name__ == "__main__":
    # Extract Small Dataset
    small_dataset = DataProvider("CO@CuBTC_3584.csv", "freq1", "raman6", "adsorp_energy", "CO@CuBTC_3584.csv")
    small_dataset.trainset_random_selection("CO@CuBTC_1000.csv", "remained.csv", n=1000)
    # Provide Data
    dataprovider = DataProvider("CO@CuBTC_1000.csv", "freq1", "raman6", "adsorp_energy", "CO@CuBTC_scaler_1000.csv")
    dataprovider.feature_standardization()
    dataprovider.trainset_random_selection("trainset.csv", "testset.csv", n=200)
    # Add Error Data
    zoomobfuscator = ZoomObfuscator("trainset.csv", 1.5, 4, "trainset_added_errordata.csv")
    zoomobfuscator.output()
    # Fit Params
    dataprovider.scalerfile = "trainset_added_errordata.csv"
